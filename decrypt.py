...
def decrypt(filepath, destination_path, key):
    ...
    #begin undiffusion
    im_undiffused = i.Image( "E:\\KULIAH\\Skripsi\\Source Code\\images\\undiffused\\"+im_encrypted.filename.split('.')[0]+".png", i.Type.UNDIFFUSED, dif.pixelManipulation(im_encrypted), key)
